...
class entregadoController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('gestor_cursos.entregado.index', compact('entregado'));
    }
    ...
    {
        return view('gestor_cursos.entregado.create');
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect('gestor_cursos/entregado');
    }
    ...
    public function show($id)
    {
        ...
        return view('gestor_cursos.entregado.show', compact('entregado'));
    }
    ...
    public function edit($id)
    {
        ...
        return view('gestor_cursos.entregado.edit', compact('entregado'));
    }
