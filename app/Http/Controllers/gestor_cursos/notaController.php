...
class notaController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('gestor_cursos.nota.index', compact('nota'));
    }
    ...
    {
        return view('gestor_cursos.nota.create');
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect('gestor_cursos/nota');
    }
    ...
    public function show($id)
    {
        ...
        return view('gestor_cursos.nota.show', compact('notum'));
    }
    ...
    public function edit($id)
    {
        ...
        return view('gestor_cursos.nota.edit', compact('notum'));
    }
