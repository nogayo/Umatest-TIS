...
class falsoverdaderoController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('gestor_cursos.falsoverdadero.index', compact('falsoverdadero'));
    }
    ...
    {
        return view('gestor_cursos.falsoverdadero.create');
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect('gestor_cursos/falsoverdadero');
    }
    ...
    public function show($id)
    {
        ...
        return view('gestor_cursos.falsoverdadero.show', compact('falsoverdadero'));
    }
    ...
    public function edit($id)
    {
        ...
        return view('gestor_cursos.falsoverdadero.edit', compact('falsoverdadero'));
    }
