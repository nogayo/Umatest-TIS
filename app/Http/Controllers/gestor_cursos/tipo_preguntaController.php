...
class tipo_preguntaController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('gestor_cursos.tipo_pregunta.index', compact('tipo_pregunta'));
    }
    ...
    {
        return view('gestor_cursos.tipo_pregunta.create');
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect('gestor_cursos/tipo_pregunta');
    }
    ...
    public function show($id)
    {
        ...
        return view('gestor_cursos.tipo_pregunta.show', compact('tipo_preguntum'));
    }
    ...
    public function edit($id)
    {
        ...
        return view('gestor_cursos.tipo_pregunta.edit', compact('tipo_preguntum'));
    }
