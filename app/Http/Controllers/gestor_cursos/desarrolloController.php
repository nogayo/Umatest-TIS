...
class desarrolloController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('gestor_cursos.desarrollo.index', compact('desarrollo'));
    }
    ...
    {
        return view('gestor_cursos.desarrollo.create');
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect('gestor_cursos/desarrollo');
    }
    ...
    public function show($id)
    {
        ...
        return view('gestor_cursos.desarrollo.show', compact('desarrollo'));
    }
    ...
    public function edit($id)
    {
        ...
        return view('gestor_cursos.desarrollo.edit', compact('desarrollo'));
    }
