...
class multiplesController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('gestor_cursos.multiples.index', compact('multiples'));
    }
    ...
    {
        return view('gestor_cursos.multiples.create');
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect('gestor_cursos/multiples');
    }
    ...
    public function show($id)
    {
        ...
        return view('gestor_cursos.multiples.show', compact('multiple'));
    }
    ...
    public function edit($id)
    {
        ...
        return view('gestor_cursos.multiples.edit', compact('multiple'));
    }
