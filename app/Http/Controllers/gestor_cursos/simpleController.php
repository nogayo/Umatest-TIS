...
class simpleController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('gestor_cursos.simple.index', compact('simple'));
    }
    ...
    {
        return view('gestor_cursos.simple.create');
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect('gestor_cursos/simple');
    }
    ...
    public function show($id)
    {
        ...
        return view('gestor_cursos.simple.show', compact('simple'));
    }
    ...
    public function edit($id)
    {
        ...
        return view('gestor_cursos.simple.edit', compact('simple'));
    }
