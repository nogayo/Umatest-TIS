...
<div class="container">
    ...
    {!! Form::model($docente, [
        ...
        'class' => 'form-horizontal'
                ...
                {!! Form::label('name', trans('docente.name'), ['class' => 'col-sm-3 control-label']) !!}
                <div class="col-sm-6">
            ...
            <div class="form-group {{ $errors->has('genero') ? 'has-error' : ''}}">
                {!! Form::label('genero', trans('docente.genero'), ['class' => 'col-sm-3 control-label']) !!}
                <div class="col-sm-6">
