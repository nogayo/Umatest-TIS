...
{{-- */$id_test=DB::table('examens')->where('id', $id_examen)->first();
        ...
        {{-- */$id_materia=DB::table('preguntas')->where('id', $id_pregunta)->first();
             ...
             /* --}}
<!--Comienza path para Crear Respuesta a preguntas de Simples.
    -->
    <div class="col-md-14 col-md-offset-0 borderpath" style="width: 43%;margin-left: 0%;">
                    ...
                    <li><a href="#"></i>Añadir Respuesta</a></li>
                    </ol>
        </div>
    <!--Termina path para Crear Respuesta a preguntas de Simples.  
    -->
    <h1 style="padding-top: 20px;">Añadir Respueta Simple</h1>
    <hr/>
