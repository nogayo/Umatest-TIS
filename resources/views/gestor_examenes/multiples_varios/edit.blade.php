...
<!--Comienza path para EDITAR Respuestas a preguntas de seleccion multiples.
    -->
    <div class="col-md-14 col-md-offset-0 borderpath" style="width: 58%;margin-left: 0%;">
                    <ol class="breadcrumb">
    ...
    {!! Form::model($multiples_vario, [
        ...
        'class' => 'form-horizontal'
            ...
            <div class="form-group {{ $errors->has('correcta') ? 'has-error' : ''}}">
                ...
                <div class="col-sm-6">
                                <div class="checkbox">
                <label>{!! Form::radio('correcta', '1') !!} Correcta</label>
            </div>
            <div class="checkbox">
                <label>{!! Form::radio('correcta', '0', true) !!} Incorrecta</label>
            </div>
